...
const FREE_FEATURES = [
  ...
  { icon: "🎯", label: "Weekly drink limit" },
  { icon: "📊", label: "Basic stats" },
    ...
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View className="mx-5 bg-accent/50 rounded-2xl p-5 mb-4 border border-border/50">
          <Text className="text-xs font-bold text-primary uppercase tracking-widest mb-4">Plus features</Text>
        ...
        <View className="mx-5 mb-6">
          <Text className="text-xs font-bold text-muted-foreground/60 uppercase tracking-widest mb-3">Always free</Text>
          <View className="flex-row flex-wrap gap-2">
            {FREE_FEATURES.map((f) => (
              <View key={f.label} className="flex-row items-center gap-1.5 bg-accent rounded-full px-3 py-1.5">
        ...
        <View className="mx-5 gap-3">
          ...
          <Pressable className="py-3 items-center" onPress={handleRestore} disabled={purchasing}>
